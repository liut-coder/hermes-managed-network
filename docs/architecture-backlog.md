...
- 架构阶段：v1.0 主体闭环已完成，进入 v1.1 Provider 化托管自动化建设；当前已落地 Provider 统一接口契约骨架（discover / plan / apply / verify / status / rollback），高风险 apply/rollback 默认走 approval/audit 占位路径。
